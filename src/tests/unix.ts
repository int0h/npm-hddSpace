...
test('fixture #2 (ubuntu: russian locale)', t => {
	let out = `
...
test('fixture #4 (ubuntu: russian locale)', t => {
	let out = `
		Filesystem     1024-blocks    Used Available Capacity Mounted on
...
test('fixture #4 (debian: russian locale)', t => {
	let out = `
